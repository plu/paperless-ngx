  ...
  filterDocuments(items: ObjectWithId[] | NgbDateStruct[]) {
    const filterRules: FilterRule[] = items.flatMap((i) => {
      if (i.hasOwnProperty('year')) {
        ...
        return [
          {
            rule_type: FILTER_CREATED_DAY,
            value: (i as NgbDateStruct).day.toString(),
          },
          {
            rule_type: FILTER_CREATED_MONTH,
            value: (i as NgbDateStruct).month.toString(),
          },
          {
            rule_type: FILTER_CREATED_YEAR,
            value: (i as NgbDateStruct).year.toString(),
          },
        ]
